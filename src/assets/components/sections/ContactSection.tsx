...
import dtop_logo from "../../images/dtop.jpg";
      ...
      <section id="contact-section">
        <div className="container">
          ...
          <div className="row justify-content-center">
            <div className="col-md-6 col-lg-4  justify-content-center d-flex mb-4 mb-md-0 contact-col">
            ...
            <div className="col-md-6 col-lg-4  justify-content-center d-flex mb-4 mb-md-0 contact-col">
              <a target="_blank" href="https://www.facebook.com/dtopgraphics">
                <img
                  id="think-logo"
                  className="img-fluid contact-logo-img"
                  src={dtop_logo}
